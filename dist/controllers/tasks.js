        ...
        switch (_a.label) {
            ...
            case 1:
                ...
                formattedTasks = tasks.map(function (task) {
                    ...
                    var formattedDate = "".concat(date.getFullYear(), "-").concat(date.getMonth() + 1, "-").concat(date.getDate());
                    return __assign(__assign({}, task._doc), { createdAt: formattedDate });
                });
                res
                    .status(200)
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                if (!title) {
                    throw new notFound_error_1.default("No task provided...Please create one", 404);
                }
                return [4 /*yield*/, task_schema_1.default.create(req.body)];
            case 1:
                task = _a.sent();
                return [2 /*return*/, res.status(201).json({ msg: "TASK_CREATED", task: task })];
        }
    });
}); });
